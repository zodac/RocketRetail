...
/**
 * Stand-alone class which compares the runtime of different method for string concatenation.<br />
 * Compares the "String +=" operation, the "StringBuffer append" operation and the "StringBuilder append" operation.<br />
...
public class TestStringAddition {
	...
	//Methods
	/**
	 * Main method. Runs the concatenation operation for the three String-type objects for N runs.<br />
