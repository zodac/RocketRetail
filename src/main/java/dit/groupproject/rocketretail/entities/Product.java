...
public class Product {
     ...
     * 
     * @param productID
     *            (int) the unique identifier for the product
     * @param productDesc
     *            (String) the product description
     * @param stockLevel
     *            (int) the current stock level for that product
     * @param maxLevel
     *            (int) the max stock level for that product
     * @param supplierID
     *            (int) the ID for the supplier carrying that product
     * @param costPrice
     *            (double) the cost price for that product
     * @param salePrice
     *            (double) the sale price for that product
     * */
    public Product(int productID, String productDesc, int stockLevel, int maxLevel, int supplierID, double costPrice,
            double salePrice) {
