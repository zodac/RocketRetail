...
public class OrderedItem {
    ...
    /**
     * Constructs an <code>OrderedItem</code> with a <code>Product</code> and
     * quantity.
     * 
     * @param product
     * @param quantity
    ...
    /**
     * 
     * @return A <code> String </code> giving the details of the
     ...
     * 
     * @param product
     *            Sets the <code>Product</code> in the <code>OrderedItem</code>.
     */
    ...
    /**
     * 
     * @return An <code>int</code> representing the ordered amount of the
     *         <code>Product</code>.
     */
     ...
     * 
     * @param quantity
     *            Sets the quantity of the <code>Product</code> to order.
     */
