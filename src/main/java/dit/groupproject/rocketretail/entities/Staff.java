...
/**
 * A class that is used to model a <code>Staff</code>
 */
public class Staff {

    private int staffID, staffPIN, gender, staffLevel; // For gender, male = 1,
                                                       // female = 2. No, that's
     ...
     * 
     * @param staffID
     *            (int) the unique identifier for staff member
     * @param staffPIN
     *            (int) the password the staff member uses to log in
     * @param staffName
     *            (String) the staff members name
     * @param gender
     *            (int) gender of staff member -male (1) or female (2)
     * @param phoneNumber
     *            (String) the phone number of the staff member
     * @param address
     *            (String) the address of the staff member
     * @param wage
     *            (double) the wage the staff member earns
     * @param staffLevel
     *            (int) the staff members level -manager (1) or employee (2)
     * @param dateAdded
     *            (String) the date the staff member was added to the system
     * */
    public Staff(int staffID, int staffPIN, String staffName, int gender, String phoneNumber, String address,
            double wage, int staffLevel, String dateAdded) {
