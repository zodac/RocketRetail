...
public class CustomerTable {
        ...
        for (int i = 0; i < ShopDriver.customers.size() + 1; i++) {
            if (i < ShopDriver.customers.size())
                customerMemberArrayEdit[i + 1] = "ID: "
                        + doubleFormatter.format(ShopDriver.customers.get(i).getCustomerID()) + " ("
                        + ShopDriver.customers.get(i).getCustomerName() + ")";
        }
    ...
    public static void add() {
        ...
        save.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (valid) {
                    ShopDriver.customers.add(new Customer(Integer.parseInt(custIDField.getText()), custNameField
    ...
    public static int firstAvailableID() {
        ...
        if (found)
            ...
            return ShopDriver.customers.size() + ShopDriver.customerIDStart;
    }
