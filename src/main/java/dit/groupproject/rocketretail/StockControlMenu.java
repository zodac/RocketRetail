...
public class StockControlMenu {
	...
	/** Create submenu and ActionListeners, and passes back to ShopDriver to add to menuBar */ 
	...
	/**
	 * Checks the stock levels of all products and displays in a bar chart.
	 * If product levels fall low, gives an option to order more stock from suppliers.
	 * Order options if stock falls below 25%, 50%, 75% or 100%.
	 * */
	 ...
	 * @param productPercentLevel (ArrayList)
	 */
	 ...
	 * @param productsToReplenish (ArrayList)
	 */
