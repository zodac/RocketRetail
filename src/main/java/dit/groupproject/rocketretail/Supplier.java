...
public class Supplier {
     ...
     *  
     * @param supplierID (int) the unique identifier for suppliers 
     * @param supplierName (String) name of the supplier 
     * @param phoneNumber (String) suppliers telephone number
     * @param address (String) suppliers address
     * @param vatNumber (String) the unique vatnumber for suppliers 
     * @param lastPurchase (String) the last date product were ordered from the supplier 
     * @param dateAdded (String) the date the supplier was added
     * */
	public Supplier(int supplierID, String supplierName, String phoneNumber, String address, String vatNumber, String lastPurchase, String dateAdded){
