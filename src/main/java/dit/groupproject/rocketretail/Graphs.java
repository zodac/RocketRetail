...
public class Graphs {
	...
	static Color colourSales = new Color(109,209,186);
	 /** 
     * A Color object containing the colour the colour representing the purchases. 
     */
	...
	//**************
	//Replaced with ShopDriver.yearCurrent - we needed a reference to the current year in the rest of the project, so just combining it into one place
	/** 
     * creates new items in the menubar
     * with actionlisteners attached
     */
	public static JMenu createMenu(){
		...
		predBarGraphTwoYearItem.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				double[][] twoYearPredictionArray = Predictions.twoYrPrediction(Predictions.createArrayFiveYear(ShopDriver.yearCurrent));
		...
		predBarGraphSixMonthItem.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){					
				...
				double[][] sixMonthPredictionArray = Predictions.sixMthPrediction(Predictions.createArrayFiveYear(ShopDriver.yearCurrent));						
	...
	/** 
     * creates an 2d array list 
     * includes profit, loss and balance
     * 
     * @param firstYear (int) 
     * @param secondYear (int) 
     * */
	public static double[][] createArrayMultipleYears(int firstYear, int secondYear) {
		
		double[][] inputArray = new double[(secondYear-firstYear)+1][3]; //5 years (by month), 3 entries per month (sales, purchases, profit/loss)
		...
		for(int i = 0; i < (secondYear-firstYear)+1; i++){
			...
			inputArray[i][1] = suppTotal; //Comes into this method as a negative value
			inputArray[i][2] = custTotal + suppTotal;
		}		
		return inputArray;
	}
	/** 
     * creates an 2d array list for 12 months
     * includes profit, loss and balance 
     * 
     * @param selectedYear (int) 
     * */
	public static double[][] createArraySingleYear(int selectedYear) {		
		double[][] dataArray = new double[12][3]; //12 months, 3 entries per month (sales, purchases, profit/loss)
		...
		for(int i = 0; i < 12; i++){
			...
			dataArray[i][1] = suppTotal; //Comes into this method as a negative value
			dataArray[i][2] = custTotal + suppTotal;
		}
		return dataArray;
	}
	/** 
     * creates an 3D bargraph
	...
	public static void BarGraphLeft(String title, double[][] dataArray, String xAxisTitle, boolean isYear){
		...
		JFreeChart chart = ChartFactory.createBarChart3D(null, xAxisTitle, "Euro (€)", createDataset(dataArray, isYear), PlotOrientation.VERTICAL, true, true, false);
		...
		chart.addSubtitle(new TextTitle(yearTitle,
			    new Font("SansSerif", Font.PLAIN, 18), new Color(82,89,110),
	...
	/** 
     * creates an 3D bargraph plotting 5 years
     * set size and position 
     * 
     * @param title (String)
     * @param dataArray (double [][])
	...
	public static void BarGraphLeft5Year(String title, double[][] dataArray, String xAxisTitle, boolean isYear){
		...
		JFreeChart chart = ChartFactory.createBarChart3D(null, xAxisTitle, "Euro (€)", fiveYearCreateDataset(dataArray, isYear), PlotOrientation.VERTICAL, true, true, false);
		chart.setBackgroundPaint(ShopDriver.backgroundColour);
	...
	/** 
     * creates an 3D bargraph predicting 6 months profit and loss
     * set size and position 
     * 
     * @param title (String)
     * @param dataArray (double [][])
...
//		ShopDriver.mainPanel = new JPanel();
		...
		JFreeChart chart = ChartFactory.createBarChart3D(null, xAxisTitle, "Euro (€)", createDatasetMth(dataArray, isYear), PlotOrientation.VERTICAL, true, true, false);
		chart.setBackgroundPaint(ShopDriver.backgroundColour);
		...
		chart.addSubtitle(new TextTitle("Prediction for " + yearTitle,
			    new Font("SansSerif", Font.PLAIN, 18), new Color(82,89,110),
			    RectangleEdge.TOP, HorizontalAlignment.CENTER,
			    VerticalAlignment.TOP, RectangleInsets.ZERO_INSETS));
	...
	/** 
     * creates an 3D bargraph predicting 2 years profit and loss
     * set size and position 
     * 
     * @param title (String)
     * @param dataArray (double [][])
...
//		ShopDriver.mainPanel = new JPanel();
		...
		JFreeChart chart = ChartFactory.createBarChart3D(null, xAxisTitle, "Euro (€)", twoYearCreateDataset(dataArray, isYear), PlotOrientation.VERTICAL, true, true, false);
		chart.setBackgroundPaint(ShopDriver.backgroundColour);
	 ...
	 */
	public static ChartPanel createProductGraph(String title, String xAxis, String yAxis, ArrayList<String> productDescription, ArrayList<Double> productPercentLevel){
		
		JFreeChart chart = ChartFactory.createBarChart(null, xAxis, yAxis, createProductDataset(productDescription, productPercentLevel), PlotOrientation.VERTICAL, true, true, false);
		chart.setBackgroundPaint(ShopDriver.backgroundColour);
	...
	/** 
     * creates a data set
     * including products and stock
     * 
     * @param productDescription (ArrayList<String>)
     * @param productPercentLevel (ArrayList<Double>)
     * */
	...
	private static DefaultCategoryDataset twoYearCreateDataset(double[][] dataArray, boolean isYear) {
		...
		String xaxis = "";
		String[] months = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
	...
	private static DefaultCategoryDataset fiveYearCreateDataset(double[][] dataArray, boolean isYear) {
		...
		String xaxis = "";
		String[] months = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
		String[] years = {""+(ShopDriver.yearCurrent-4), ""+(ShopDriver.yearCurrent-3), ""+(ShopDriver.yearCurrent-2), ""+(ShopDriver.yearCurrent-1), ""+(ShopDriver.yearCurrent-0), ""+ShopDriver.yearCurrent};
	...
	/** 
     * creates an 3D bargraph plotting 12 months profit and loss
     * set size and position 
     * 
     * @param title (String)
     * @param dataArray (double [][])
		...
		if(isYear){
			...
			firstYear.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e){
					...
					double[][] inputArray = createArrayMultipleYears(firstYear.getSelectedIndex()+(ShopDriver.yearStart-1), (firstYear.getSelectedIndex()+4)+(ShopDriver.yearStart-1));
					startYearIndex = firstYear.getSelectedIndex();
	...
	/** 
     * creates an 3D bargraph plotting 5 years Profit and Loss
     * set size and position 
     * 
     * @param title (String)
     * @param dataArray (double [][])
	...
	/** 
     * creates an 3D bargraph plotting Profit and Loss
     * set size and position 
     * 
     * @param title (String)
     * @param dataArray (double [][])
		...
		if(isYear){
			...
			firstYear.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e){
					...
					double[][] inputArray = createArrayMultipleYears(firstYear.getSelectedIndex()+(ShopDriver.yearStart-1), (firstYear.getSelectedIndex()+4)+(ShopDriver.yearStart-1));
					startYearIndex = firstYear.getSelectedIndex();
					BarGraph("Title", inputArray, firstYear.getSelectedItem() + "-" + (firstYear.getSelectedIndex()+ShopDriver.yearStart + 4), true);
					}
				}
			});
	...
	/**
	 * 
	 * creates a pie chart plotting sales breakdown
     * set size and position 
	 * 
	 * @param chartTitle
	 * @param staffID
	...
	/** 
     * creates a data set
     * including staff and sales
     * 
     * @param salesBreakdown (double [])
